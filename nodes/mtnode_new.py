...
class XSensDriver(object):
	...
	def __init__(self):
		...
		self.diag_pub = rospy.Publisher('/diagnostics', DiagnosticArray, queue_size=400)
		...
		self.imu_pub = rospy.Publisher('imu/data', Imu, queue_size=400)
		self.gps_pub = rospy.Publisher('fix', NavSatFix, queue_size=400)
		self.xgps_pub = rospy.Publisher('fix_extended', GPSFix, queue_size=400)
		self.vel_pub = rospy.Publisher('velocity', TwistStamped, queue_size=400)
		self.mag_pub = rospy.Publisher('magnetic', Vector3Stamped, queue_size=400)
		self.temp_pub = rospy.Publisher('temperature', Float32, queue_size=400)	# decide type+header
		self.press_pub = rospy.Publisher('pressure', Float32, queue_size=400) # decide type+header
		self.analog_in1_pub = rospy.Publisher('analog_in1', UInt16, queue_size=400) # decide type+header
		self.analog_in2_pub = rospy.Publisher('analog_in2', UInt16, queue_size=400) # decide type+header
		...
		self.str_pub = rospy.Publisher('imu_data_str', String, queue_size=400)
